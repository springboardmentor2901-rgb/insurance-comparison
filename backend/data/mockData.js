export const policies = [
    // ===== LIFE INSURANCE =====
    {
        id: 1, name: 'SecureLife Basic', type: 'Life', coverage: 500000, premium: 3200, duration: 10, rating: 4.2,
    ...
    {
        id: 2, name: 'TermMax 50', type: 'Life', coverage: 5000000, premium: 6800, duration: 30, rating: 4.7,
    ...
    {
        id: 3, name: 'LifeShield Gold', type: 'Life', coverage: 2000000, premium: 5400, duration: 20, rating: 4.5,
    ...
    {
        id: 4, name: 'PureProtect Term', type: 'Life', coverage: 10000000, premium: 9500, duration: 25, rating: 4.8,
    ...
    // ===== HEALTH INSURANCE =====
    {
        id: 5, name: 'HealthGuard Pro', type: 'Health', coverage: 1000000, premium: 8500, duration: 1, rating: 4.6,
    ...
    {
        id: 6, name: 'FamilyFirst Plus', type: 'Health', coverage: 2500000, premium: 18000, duration: 1, rating: 4.8,
    ...
    {
        id: 7, name: 'MediCare Lite', type: 'Health', coverage: 300000, premium: 3800, duration: 1, rating: 4.0,
    ...
    {
        id: 8, name: 'HealthMax Super', type: 'Health', coverage: 5000000, premium: 24000, duration: 1, rating: 4.9,
    ...
    // ===== AUTO INSURANCE =====
    {
        id: 9, name: 'AutoShield Premium', type: 'Auto', coverage: 750000, premium: 12000, duration: 1, rating: 4.4,
    ...
    {
        id: 10, name: 'DriveSafe Basic', type: 'Auto', coverage: 300000, premium: 4500, duration: 1, rating: 3.9,
    ...
    {
        id: 11, name: 'AutoElite 360', type: 'Auto', coverage: 1500000, premium: 18500, duration: 1, rating: 4.7,
    ...
    {
        id: 12, name: 'TwoWheeler Guard', type: 'Auto', coverage: 150000, premium: 2200, duration: 1, rating: 4.2,
    ...
    // ===== PROPERTY INSURANCE =====
    {
        id: 13, name: 'HomeSafe 360', type: 'Property', coverage: 3000000, premium: 4500, duration: 5, rating: 4.3,
    ...
    {
        id: 14, name: 'PropertyGuard Basic', type: 'Property', coverage: 1000000, premium: 1800, duration: 3, rating: 4.0,
    ...
    {
        id: 15, name: 'EstateShield Premium', type: 'Property', coverage: 10000000, premium: 12000, duration: 10, rating: 4.6,
    ...
    // ===== TRAVEL INSURANCE =====
    {
        id: 16, name: 'TravelEase Global', type: 'Travel', coverage: 2000000, premium: 1500, duration: 1, rating: 4.5,
    ...
    {
        id: 17, name: 'DomesticTrip Lite', type: 'Travel', coverage: 500000, premium: 450, duration: 1, rating: 4.1,
    ...
    {
        id: 18, name: 'FrequentFlyer Pro', type: 'Travel', coverage: 5000000, premium: 6500, duration: 1, rating: 4.7,
    ...
    // ===== CYBER INSURANCE =====
    {
        id: 19, name: 'CyberGuard Elite', type: 'Cyber', coverage: 1000000, premium: 2200, duration: 1, rating: 4.1,
    ...
    {
        id: 20, name: 'NetSafe Basic', type: 'Cyber', coverage: 250000, premium: 800, duration: 1, rating: 3.8,
    ...
    {
        id: 21, name: 'DigitalFortress Max', type: 'Cyber', coverage: 5000000, premium: 7500, duration: 1, rating: 4.5,
...
export let claims = [
    {
        ...
        status: 'Approved', fullName: 'Rahul Sharma', email: 'rahul.sharma@email.com',
    ...
    },
    {
        ...
        status: 'Under Review', fullName: 'Priya Patel', email: 'priya.patel@email.com',
    ...
    },
    {
        ...
        status: 'Submitted', fullName: 'Ankit Verma', email: 'ankit.v@email.com',
    ...
    },
    {
        ...
        status: 'Approved', fullName: 'Sneha Joshi', email: 'sneha.j@email.com',
